    ...
    try {
      const { data, error } = await supabase
        ...
        .insert({
          ...
          registration_certificate_valid_until: newEmployee.registrationCertificateValidUntil || null,
          registration_certificate_storage_path: newEmployee.registrationCertificateStoragePath || null,
          registration_certificate_file_name: newEmployee.registrationCertificateFileName || null,
      ...
      const mapped: Employee = {
        ...
        registrationCertificateValidUntil: data.registration_certificate_valid_until || undefined,
        registrationCertificateStoragePath: data.registration_certificate_storage_path || undefined,
        registrationCertificateFileName: data.registration_certificate_file_name || undefined,
    ...
    try {
      const { data, error } = await supabase
        ...
        .update({
          ...
          registration_certificate_valid_until: updatedEmployee.registrationCertificateValidUntil || null,
          registration_certificate_storage_path: updatedEmployee.registrationCertificateStoragePath || null,
          registration_certificate_file_name: updatedEmployee.registrationCertificateFileName || null,
